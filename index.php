  ...
  <main>
    ...
    <section class="profile">
      ...
      <div class="container inview fadeIn">
        <div class="container-img">
          <img src="http://myportfolio.local/wp-content/themes/my-portfolio03/img/my-profile-img-sp.png" alt="">
        </div>
    ...
    <section class="concept">
      ...
      <div class="container inview fadeIn">
        <div class="container-img">
          ...
          <img src="http://myportfolio.local/wp-content/themes/my-portfolio03/img/concept-img-pc@2x.png" alt="Example imagealt="">
          </div>
          <div class=" container-txt inview fadeIn">
      ...
      <div class="container">
        <div class="container-list inview fadeIn">
          <div class="container-list__icon">
            <img src="http://myportfolio.local/wp-content/themes/my-portfolio03/svg/design.svg" alt="">
          </div>
        ...
        <div class="container-list inview fadeIn">
          <div class="container-list__icon">
            <img src="http://myportfolio.local/wp-content/themes/my-portfolio03/svg/human.svg" alt="">
          </div>
          <div class="container-list__txt">
            <p>人事経験</p>
        ...
        <div class="container-list inview fadeIn">
          <div class="container-list__icon">
            <img src="http://myportfolio.local/wp-content/themes/my-portfolio03/svg/management.svg" alt="">
          </div>
          <div class="container-list__txt">
            <p>マネジメント</p>
        ...
        <div class="container-list inview fadeIn">
          <div class="container-list__icon">
            <img src="http://myportfolio.local/wp-content/themes/my-portfolio03/svg/Continuation.svg" alt="">
          </div>
          <div class="container-list__txt">
            <p>継続力</p>
    ...
    <section class="skills">
      ...
      <div class="container">
        ...
        <div class="container-list inview fadeIn">
          <div class="container-list__icon">
            <img src="http://myportfolio.local/wp-content/themes/my-portfolio03/svg/html-icon.svg" alt="">
          </div>
          <div class="container-list__txt">
            <p>HTML/css</p>
        ...
        <div class="container-list inview fadeIn">
          <div class="container-list__icon">
            <img src="http://myportfolio.local/wp-content/themes/my-portfolio03/svg/js-icon.svg" alt="">
          </div>
          <div class="container-list__txt">
        ...
        <div class="container-list inview fadeIn">
          <div class="container-list__icon">
            <img src="http://myportfolio.local/wp-content/themes/my-portfolio03/svg/wordpress-icon.svg" alt="">
          </div>
          <div class="container-list__txt">
            <p>Wordpress</p>
        ...
        <div class="container-list inview fadeIn">
          <div class="container-list__icon">
            <img src="http://myportfolio.local/wp-content/themes/my-portfolio03/svg/php-icon.svg" alt="">
          </div>
          <div class="container-list__txt">
            <p>PHP</p>
        ...
        <div class="container-list inview fadeIn">
          <div class="container-list__icon">
            <img src="http://myportfolio.local/wp-content/themes/my-portfolio03/svg/photoshop-icon.svg" alt="">
          </div>
          <div class="container-list__txt">
            <p>Photoshop</p>
        ...
        <div class="container-list inview fadeIn">
          <div class="container-list__icon">
            <img src="http://myportfolio.local/wp-content/themes/my-portfolio03/svg/frame-icon.svg" alt="">
          </div>
          <div class="container-list__txt">
            <p>ワイヤーフレーム</p>
    ...
    <section class="contact">
      ...
      <div class="contact-icon inview fadeIn">
        <div class="contact-icon__twitter">
          <a href="https://twitter.com/nishi0128s"><img src="http://myportfolio.local/wp-content/themes/my-portfolio03/svg/twitter.svg" alt=""></a>
        </div>
        <div class="contact-icon__email">
          <a href="mailto:shota.ns0128@gmail.com"><img src="http://myportfolio.local/wp-content/themes/my-portfolio03/svg/my-email.svg" alt=""></a>
        </div>
      </div>
    </section>
    <!-- contact -->
